                        ...
                        <div class="col-md-8 col-lg-8 col-sm-6 col-xs-6">
                            <nav class="mainmenu__nav hidden-xs hidden-sm">
                                <ul class="main__menu">
                                    ...
                                    <li class="drop"><a href="portfolio-card-box-2.html">Danh mục</a>
                                        <ul class="dropdown">
                                            <li><a href="portfolio-card-box-2.html">Danh mục</a></li>
                                            <li><a href="single-portfolio.html">Chi tiết danh mục</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="drop"><a href="shop.html">Cửa hàng</a>
                                        <ul class="dropdown mega_dropdown">
                                            <!-- Bắt đầu Mega Menu đơn -->
                                            <li><a class="mega__title" href="shop.html">Bố cục cửa hàng</a>
                                                <ul class="mega__item">
                                                    <li><a href="shop.html">Cửa hàng mặc định</a></li>
                                                </ul>
                                            </li>
                                            <!-- Kết thúc Mega Menu đơn -->
                                            <!-- Bắt đầu Mega Menu đơn -->
                                            <li><a class="mega__title" href="shop.html">Bố cục chi tiết sản phẩm</a>
                                                <ul class="mega__item">
                                                    <li><a href="product-details.html">Kiểu tab 1</a></li>
                                            </li>
                                        </ul>
                                    </li>
                                    <!-- Kết thúc Mega Menu đơn -->
                                ...
                                <li class="drop"><a href="#">trang</a>
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="#">lời chứng thực <span><i class="zmdi zmdi-chevron-right"></i></span></a>
                                            <ul class="lavel-dropdown">
                                                <li><a href="customer-review.html">đánh giá của khách hàng</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="shop.html">cửa hàng</a></li>
                                        <li><a href="shop-sidebar.html">cửa hàng có thanh bên</a></li>
                                ...
                                <nav id="mobile_dropdown">
                                    <ul>
                                        ...
                                        <li><a href="#">Trang</a>
                                            <ul>
                                                <li><a href="about.html">Giới thiệu</a></li>
                                                <li><a href="customer-review.html">Đánh giá khách hàng</a></li>
                                                <li><a href="shop.html">Cửa hàng</a></li>
                                                <li><a href="shop-sidebar.html">Cửa hàng có thanh bên</a></li>
                                                <li><a href="product-details.html">Chi tiết sản phẩm</a></li>
                                                <li><a href="cart.html">Giỏ hàng</a></li>
            ...
            <div class="offsetmenu">
                <div class="offsetmenu__inner">
                    ...
                    <div class="off__contact">
                        ...
                        <p>Chả biết ghi gì vào đây nữa -_-</p>
                    </div>
                    ...
                    <div class="offset__sosial__share">
                        <h4 class="offset__title">Hãy theo dõi chúng tôi trên</h4>
                    ...
                    <div class="shp__cart__wrap">
                        <div class="shp__single__product">
                            ...
                            <div class="remove__btn">
                                <a href="#" title="Xóa sản phẩm này"><i class="zmdi zmdi-close"></i></a>
                            </div>
                        </div>
                        <div class="shp__single__product">
                            <div class="shp__pro__thumb">
                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                ...
                                <nav class="bradcaump-inner">
                                    ...
                                    <span class="breadcrumb-item active">Về chúng tôi</span>
                                </nav>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section__title section__title--2 text-center">
                            <h2 class="title__line">Chào mừng đến PC Store</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="htc__choose__wrap bg__cat--4">
                            <h2 class="choose__title">Vì sao nên chọn chúng tôi?</h2>
        ...
        <section class="htc__team__area bg__white ptb--120">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="section__title section__title--2 text-center">
                            <h2 class="title__line">Nhân viên của chúng tôi</h2>
                    ...
                    <div class="team__wrap clearfix mt--60">
                        ...
                        <div class="col-md-4 col-lg-4 hidden-sm col-xs-12 xmt-30">
                            <div class="team foo">
                                ...
                                <div class="team__hover__info">
                                    <div class="team__hover__action">
                                        <h2><a href="#">Nguyễn Tuấn Long</a></h2>
                                        <ul class="social__icon">
                                            <li><a href="#"><i class="zmdi zmdi-twitter"></i></a></li>
                                            <li><a href="#"><i class="zmdi zmdi-instagram"></i></a></li>
                                            <li><a href="#"><i class="zmdi zmdi-facebook"></i></a></li>
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="testimonial__wrap owl-carousel owl-theme clearfix">
                            ...
                            <div class="testimonial">
                                ...
                                <div class="testimonial__details">
                                    ...
                                    <div class="test__info">
                                        <span><a href="#">Hồ Ngọc Mai</a></span>
                                        <span> - </span>
                            ...
                            <div class="testimonial">
                                ...
                                <p>Ý kiến khách hàng</p>
                                    <div class="test__info">
                                        <span><a href="#">Trần Thị Bình</a></span>
                                        <span> - </span>
                                        <span>Khách hàng</span>
                                    </div>
                                </div>
                            ...
                            <div class="testimonial">
                                ...
                                <div class="testimonial__details">
                                    <p>Ý kiến khách hàng</p>
                                    <div class="test__info">
                                        <span><a href="#">Nguyễn Văn An</a></span>
                                        <span> - </span>
                                        <span>Khách hàng</span>
                                    </div>
                                </div>
