<?php
    ...
    { 
        ...
        {
            $array["firstnameError"] = "Trường này không được để trống";
            $array["isSuccess"] = false; 
        } 

        if (empty($array["name"]))
        {
            $array["nameError"] = "Trường này không được để trống";
            $array["isSuccess"] = false; 
        } 

        if(!isEmail($array["email"])) 
        {
            $array["emailError"] = "Email không hợp lệ";
            $array["isSuccess"] = false; 
        } 
        ...
        {
            $array["passwordError"] = "Trường này không được để trống";
            $array["isSuccess"] = false; 
        }
        ...
        if($array["isSuccess"]) 
        {
            ...
            $array["isSuccess"] = false;
            $array["emailError"] = "Tài khoản này đã tồn tại!";
